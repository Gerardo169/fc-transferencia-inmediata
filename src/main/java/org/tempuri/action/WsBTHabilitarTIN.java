 ...
 * 2023-06-22T16:00:59.310-05:00
 * Generated source version: 3.3.0
 *
 */
@WebServiceClient(name = "wsBTHabilitarTIN",
                  wsdlLocation = "file:/C:/bantotal/fc-transferencia-inmediata/src/main/resources/wsdl/wsBTHabilitarTIN.wsdl",
...
public class WsBTHabilitarTIN extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/bantotal/fc-transferencia-inmediata/src/main/resources/wsdl/wsBTHabilitarTIN.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WsBTHabilitarTIN.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/bantotal/fc-transferencia-inmediata/src/main/resources/wsdl/wsBTHabilitarTIN.wsdl");
        }
        WSDL_LOCATION = url;
    }
