 ...
 * 2023-06-22T16:00:59.403-05:00
 * Generated source version: 3.3.0
 *
 */
@WebServiceClient(name = "wsBTRecepcionTIN",
                  wsdlLocation = "file:/C:/bantotal/fc-transferencia-inmediata/src/main/resources/wsdl/wsBTRecepcionTIN.wsdl",
...
public class WsBTRecepcionTIN extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/bantotal/fc-transferencia-inmediata/src/main/resources/wsdl/wsBTRecepcionTIN.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WsBTRecepcionTIN.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/bantotal/fc-transferencia-inmediata/src/main/resources/wsdl/wsBTRecepcionTIN.wsdl");
        }
        WSDL_LOCATION = url;
    }
